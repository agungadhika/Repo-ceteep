...
.field private p:Lio/flutter/embedding/android/r;
...
.field private final t:Lb/c/c/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lb/c/c/a<",
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lio/flutter/embedding/android/i;)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/k;->t:Lb/c/c/a;
...
.method private k()Lio/flutter/embedding/android/k$f;
    ...
    sget-object v0, Lio/flutter/embedding/android/k$f;->f:Lio/flutter/embedding/android/k$f;
    ...
    sget-object v0, Lio/flutter/embedding/android/k$f;->e:Lio/flutter/embedding/android/k$f;
    ...
    :cond_3
    sget-object v0, Lio/flutter/embedding/android/k$f;->g:Lio/flutter/embedding/android/k$f;

    return-object v0

    :cond_4
    sget-object v0, Lio/flutter/embedding/android/k$f;->d:Lio/flutter/embedding/android/k$f;
...
.method public j(Lio/flutter/embedding/engine/b;)V
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/b;->p()Lio/flutter/embedding/engine/renderer/a;
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/engine/b;->t()Lio/flutter/embedding/engine/j/n;
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/engine/b;->p()Lio/flutter/embedding/engine/renderer/a;
    ...
    invoke-virtual {v0, v1}, Lio/flutter/plugin/platform/l;->d(Lio/flutter/view/c;)V
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/android/k$e;->a(Lio/flutter/embedding/engine/b;)V
    ...
    invoke-interface {p1}, Lio/flutter/embedding/engine/renderer/b;->c()V
...
.method protected n()Lio/flutter/embedding/android/r;
    .locals 4
    ...
    invoke-direct {v0, v1}, Lio/flutter/embedding/android/r;-><init>(Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;)V
    :try_end_0
...
.method public o()V
    ...
    invoke-interface {v1}, Lio/flutter/embedding/android/k$e;->b()V
...
.method public final onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    :cond_5
    sget-object v1, Lio/flutter/embedding/android/k$f;->d:Lio/flutter/embedding/android/k$f;
    ...
    sget-object v5, Lio/flutter/embedding/android/k$f;->f:Lio/flutter/embedding/android/k$f;

    if-eq v1, v5, :cond_9

    sget-object v5, Lio/flutter/embedding/android/k$f;->g:Lio/flutter/embedding/android/k$f;
    ...
    sget-object v3, Lio/flutter/embedding/android/k$f;->e:Lio/flutter/embedding/android/k$f;

    if-eq v1, v3, :cond_c

    sget-object v3, Lio/flutter/embedding/android/k$f;->g:Lio/flutter/embedding/android/k$f;
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/android/k;->n()Lio/flutter/embedding/android/r;

    move-result-object v0

    iput-object v0, p0, Lio/flutter/embedding/android/k;->p:Lio/flutter/embedding/android/r;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/k;->p:Lio/flutter/embedding/android/r;
    ...
    invoke-static {v2}, Lb/c/a/a;->a(Landroid/content/Context;)Ljava/util/concurrent/Executor;

    move-result-object v2

    iget-object v3, p0, Lio/flutter/embedding/android/k;->t:Lb/c/c/a;

    invoke-virtual {v1, v0, v2, v3}, Lio/flutter/embedding/android/r;->a(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lb/c/c/a;)V
...
.method protected onDetachedFromWindow()V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/k;->p:Lio/flutter/embedding/android/r;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lio/flutter/embedding/android/k;->t:Lb/c/c/a;

    invoke-virtual {v0, v1}, Lio/flutter/embedding/android/r;->b(Lb/c/c/a;)V
...
.method protected setWindowInfoListenerDisplayFeatures(Landroidx/window/layout/WindowLayoutInfo;)V
    ...
    invoke-static {v2, v3}, Lc/a/b;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method x()V
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/engine/b;->r()Lio/flutter/embedding/engine/j/l;
