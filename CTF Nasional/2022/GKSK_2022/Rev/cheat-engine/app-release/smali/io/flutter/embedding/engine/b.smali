...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lio/flutter/embedding/engine/h/d;Lio/flutter/embedding/engine/FlutterJNI;Lio/flutter/plugin/platform/l;[Ljava/lang/String;ZZ)V
    .locals 6
    ...
    invoke-virtual {v1}, Lc/a/a;->d()Lio/flutter/embedding/engine/FlutterJNI$c;
    ...
    invoke-direct {v2, p3, v0}, Lio/flutter/embedding/engine/f/b;-><init>(Lio/flutter/embedding/engine/FlutterJNI;Landroid/content/res/AssetManager;)V

    iput-object v2, p0, Lio/flutter/embedding/engine/b;->c:Lio/flutter/embedding/engine/f/b;

    invoke-virtual {v2}, Lio/flutter/embedding/engine/f/b;->l()V
    ...
    invoke-direct {v3, v2, p3}, Lio/flutter/embedding/engine/j/b;-><init>(Lio/flutter/embedding/engine/f/b;Lio/flutter/embedding/engine/FlutterJNI;)V
    ...
    invoke-direct {v3, v2}, Lio/flutter/embedding/engine/j/c;-><init>(Lio/flutter/embedding/engine/f/b;)V
    ...
    invoke-direct {v4, v2}, Lio/flutter/embedding/engine/j/e;-><init>(Lio/flutter/embedding/engine/f/b;)V
    ...
    invoke-direct {v4, v2}, Lio/flutter/embedding/engine/j/f;-><init>(Lio/flutter/embedding/engine/f/b;)V
    ...
    invoke-direct {v5, v2}, Lio/flutter/embedding/engine/j/g;-><init>(Lio/flutter/embedding/engine/f/b;)V
    ...
    invoke-direct {v5, v2}, Lio/flutter/embedding/engine/j/h;-><init>(Lio/flutter/embedding/engine/f/b;)V
    ...
    invoke-direct {v5, v2}, Lio/flutter/embedding/engine/j/i;-><init>(Lio/flutter/embedding/engine/f/b;)V
    ...
    invoke-direct {v5, v2, p7}, Lio/flutter/embedding/engine/j/k;-><init>(Lio/flutter/embedding/engine/f/b;Z)V
    ...
    invoke-direct {p7, v2}, Lio/flutter/embedding/engine/j/l;-><init>(Lio/flutter/embedding/engine/f/b;)V
    ...
    invoke-direct {p7, v2}, Lio/flutter/embedding/engine/j/m;-><init>(Lio/flutter/embedding/engine/f/b;)V
    ...
    invoke-direct {p7, v2}, Lio/flutter/embedding/engine/j/n;-><init>(Lio/flutter/embedding/engine/f/b;)V
    ...
    invoke-virtual {v1}, Lc/a/a;->c()Lio/flutter/embedding/engine/h/d;
    ...
    invoke-virtual {p2, v0}, Lio/flutter/embedding/engine/h/d;->h(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lio/flutter/embedding/engine/i/f/a;->a(Lio/flutter/embedding/engine/b;)V
...
.method public constructor <init>(Landroid/content/Context;[Ljava/lang/String;ZZ)V
    ...
    invoke-direct/range {v0 .. v7}, Lio/flutter/embedding/engine/b;-><init>(Landroid/content/Context;Lio/flutter/embedding/engine/h/d;Lio/flutter/embedding/engine/FlutterJNI;Lio/flutter/plugin/platform/l;[Ljava/lang/String;ZZ)V
...
.method private d()V
    ...
    invoke-direct {p0}, Lio/flutter/embedding/engine/b;->u()Z
...
.method public e()V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/b;->c:Lio/flutter/embedding/engine/f/b;

    invoke-virtual {v0}, Lio/flutter/embedding/engine/f/b;->m()V
...
.method public g()Lio/flutter/embedding/engine/i/b/b;
    .locals 1
...
.method public h()Lio/flutter/embedding/engine/f/b;
    .locals 1
...
.method public p()Lio/flutter/embedding/engine/renderer/a;
    .locals 1
...
.method public q()Lio/flutter/embedding/engine/j/k;
    .locals 1
...
.method public r()Lio/flutter/embedding/engine/j/l;
    .locals 1
...
.method public s()Lio/flutter/embedding/engine/j/m;
    .locals 1
...
.method public t()Lio/flutter/embedding/engine/j/n;
    .locals 1
