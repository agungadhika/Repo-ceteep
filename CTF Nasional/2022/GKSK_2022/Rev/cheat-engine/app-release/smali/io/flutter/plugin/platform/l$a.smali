...
.method private synthetic k(Lio/flutter/embedding/engine/j/j$b;Landroid/view/View;Z)V
    ...
    invoke-static {p2}, Lio/flutter/plugin/platform/l;->k(Lio/flutter/plugin/platform/l;)Lio/flutter/embedding/engine/j/j;
...
.method private synthetic m(Lio/flutter/plugin/platform/m;Ljava/lang/Runnable;)V
    .locals 1

    iget-object v0, p0, Lio/flutter/plugin/platform/l$a;->a:Lio/flutter/plugin/platform/l;

    invoke-static {v0, p1}, Lio/flutter/plugin/platform/l;->j(Lio/flutter/plugin/platform/l;Lio/flutter/plugin/platform/m;)V
...
.method public a(I)V
    ...
    invoke-static {v0}, Lio/flutter/plugin/platform/l;->m(Lio/flutter/plugin/platform/l;)Landroid/util/SparseArray;
...
.method public b(Z)V
    ...
    invoke-static {v0, p1}, Lio/flutter/plugin/platform/l;->i(Lio/flutter/plugin/platform/l;Z)Z
...
.method public c(Lio/flutter/embedding/engine/j/j$c;Ljava/lang/Runnable;)V
    ...
    invoke-static {v1, v2, v3}, Lio/flutter/plugin/platform/l;->o(Lio/flutter/plugin/platform/l;D)I
    ...
    invoke-static {v2, v3, v4}, Lio/flutter/plugin/platform/l;->o(Lio/flutter/plugin/platform/l;D)I

    move-result p1

    iget-object v2, p0, Lio/flutter/plugin/platform/l$a;->a:Lio/flutter/plugin/platform/l;

    invoke-static {v2, v1, p1}, Lio/flutter/plugin/platform/l;->p(Lio/flutter/plugin/platform/l;II)V

    iget-object v2, p0, Lio/flutter/plugin/platform/l$a;->a:Lio/flutter/plugin/platform/l;

    invoke-static {v2, v0}, Lio/flutter/plugin/platform/l;->h(Lio/flutter/plugin/platform/l;Lio/flutter/plugin/platform/m;)V

    new-instance v2, Lio/flutter/plugin/platform/a;

    invoke-direct {v2, p0, v0, p2}, Lio/flutter/plugin/platform/a;-><init>(Lio/flutter/plugin/platform/l$a;Lio/flutter/plugin/platform/m;Ljava/lang/Runnable;)V
...
.method public d(I)V
    ...
    invoke-static {v2}, Lio/flutter/plugin/platform/l;->m(Lio/flutter/plugin/platform/l;)Landroid/util/SparseArray;
...
.method public e(I)V
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/l;->g(Lio/flutter/plugin/platform/l;)Lio/flutter/plugin/editing/e;
...
.method public f(Lio/flutter/embedding/engine/j/j$b;)J
    ...
    invoke-virtual {v0, v1}, Lio/flutter/plugin/platform/j;->a(Ljava/lang/String;)Lio/flutter/plugin/platform/h;
    ...
    invoke-virtual {v4}, Lio/flutter/plugin/platform/h;->b()Lc/a/c/a/g;
    ...
    invoke-static {v0, v1, v2}, Lio/flutter/plugin/platform/l;->o(Lio/flutter/plugin/platform/l;D)I
    ...
    invoke-static {v0, v6, v7}, Lio/flutter/plugin/platform/l;->p(Lio/flutter/plugin/platform/l;II)V

    iget-object v0, p0, Lio/flutter/plugin/platform/l$a;->a:Lio/flutter/plugin/platform/l;

    invoke-static {v0}, Lio/flutter/plugin/platform/l;->q(Lio/flutter/plugin/platform/l;)Lio/flutter/view/d;
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/l;->l(Lio/flutter/plugin/platform/l;)Landroid/content/Context;

    move-result-object v2

    iget-object v1, p0, Lio/flutter/plugin/platform/l$a;->a:Lio/flutter/plugin/platform/l;

    invoke-static {v1}, Lio/flutter/plugin/platform/l;->r(Lio/flutter/plugin/platform/l;)Lio/flutter/plugin/platform/e;
    ...
    invoke-direct {v10, p0, p1}, Lio/flutter/plugin/platform/b;-><init>(Lio/flutter/plugin/platform/l$a;Lio/flutter/embedding/engine/j/j$b;)V

    move-object v5, v0

    invoke-static/range {v2 .. v10}, Lio/flutter/plugin/platform/m;->a(Landroid/content/Context;Lio/flutter/plugin/platform/e;Lio/flutter/plugin/platform/h;Lio/flutter/view/d$a;IIILjava/lang/Object;Landroid/view/View$OnFocusChangeListener;)Lio/flutter/plugin/platform/m;
    ...
    invoke-static {v2}, Lio/flutter/plugin/platform/l;->s(Lio/flutter/plugin/platform/l;)Lio/flutter/embedding/android/k;
...
.method public h(Lio/flutter/embedding/engine/j/j$b;)V
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/h;->b()Lc/a/c/a/g;
    ...
    invoke-static {v2}, Lio/flutter/plugin/platform/l;->l(Lio/flutter/plugin/platform/l;)Landroid/content/Context;
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/l;->m(Lio/flutter/plugin/platform/l;)Landroid/util/SparseArray;
...
.method public synthetic n(Lio/flutter/plugin/platform/m;Ljava/lang/Runnable;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/l$a;->m(Lio/flutter/plugin/platform/m;Ljava/lang/Runnable;)V
