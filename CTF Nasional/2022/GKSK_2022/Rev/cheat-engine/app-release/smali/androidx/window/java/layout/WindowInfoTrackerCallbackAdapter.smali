...
.method private final addListener(Ljava/util/concurrent/Executor;Lb/c/c/a;Lkotlinx/coroutines/k2/b;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p1}, Lkotlinx/coroutines/l0;->a(Ld/s/g;)Lkotlinx/coroutines/k0;
    ...
    invoke-direct {v4, p3, p2, v5}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter$addListener$1$1;-><init>(Lkotlinx/coroutines/k2/b;Lb/c/c/a;Ld/s/d;)V

    const/4 v5, 0x3

    const/4 v6, 0x0

    invoke-static/range {v1 .. v6}, Lkotlinx/coroutines/i;->b(Lkotlinx/coroutines/k0;Ld/s/g;Lkotlinx/coroutines/m0;Ld/v/c/p;ILjava/lang/Object;)Lkotlinx/coroutines/n1;
...
.method private final removeListener(Lb/c/c/a;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public final addWindowLayoutInfoListener(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lb/c/c/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2, p3, p1}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->addListener(Ljava/util/concurrent/Executor;Lb/c/c/a;Lkotlinx/coroutines/k2/b;)V

    return-void
.end method

.method public final removeWindowLayoutInfoListener(Lb/c/c/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->removeListener(Lb/c/c/a;)V
