...
.method public static final b(Ld/s/d;Ljava/lang/Object;Ld/v/c/l;)V
    .locals 6
    ...
    invoke-static {p1, p2}, Lkotlinx/coroutines/c0;->b(Ljava/lang/Object;Ld/v/c/l;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v1}, Lkotlinx/coroutines/f0;->n(Ld/s/g;)Z
    ...
    invoke-virtual {p1, p2, p0}, Lkotlinx/coroutines/f0;->k(Ld/s/g;Ljava/lang/Runnable;)V
    ...
    invoke-interface {v3, v4}, Ld/s/g;->get(Ld/s/g$c;)Ld/s/g$b;
    ...
    invoke-interface {v3}, Lkotlinx/coroutines/n1;->j()Ljava/util/concurrent/CancellationException;

    move-result-object v3

    invoke-virtual {p0, p2, v3}, Lkotlinx/coroutines/internal/g;->a(Ljava/lang/Object;Ljava/lang/Throwable;)V

    sget-object p2, Ld/j;->d:Ld/j$a;

    invoke-static {v3}, Ld/k;->a(Ljava/lang/Throwable;)Ljava/lang/Object;

    move-result-object p2

    invoke-static {p2}, Ld/j;->a(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-interface {p0, p2}, Ld/s/d;->resumeWith(Ljava/lang/Object;)V
    ...
    iget-object p2, p0, Lkotlinx/coroutines/internal/g;->h:Ld/s/d;
    ...
    invoke-static {v4, v3}, Lkotlinx/coroutines/internal/d0;->c(Ld/s/g;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p2, v4, v3}, Lkotlinx/coroutines/e0;->e(Ld/s/d;Ld/s/g;Ljava/lang/Object;)Lkotlinx/coroutines/g2;
    ...
    :cond_4
    invoke-static {v4, v3}, Lkotlinx/coroutines/internal/d0;->a(Ld/s/g;Ljava/lang/Object;)V
    ...
    :try_start_3
    invoke-virtual {p0, p1, v2}, Lkotlinx/coroutines/s0;->f(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_2

    :goto_3
    invoke-virtual {v0, v1}, Lkotlinx/coroutines/y0;->p(Z)V
...
.method public static synthetic c(Ld/s/d;Ljava/lang/Object;Ld/v/c/l;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lkotlinx/coroutines/internal/h;->b(Ld/s/d;Ljava/lang/Object;Ld/v/c/l;)V
