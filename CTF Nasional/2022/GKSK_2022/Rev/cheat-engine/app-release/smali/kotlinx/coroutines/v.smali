...
# static fields
.field public static final e:Lkotlinx/coroutines/v;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkotlinx/coroutines/v;->e:Lkotlinx/coroutines/v;
    ...
    :cond_0
    invoke-static {v0}, Ld/a0/d;->f(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    :goto_1
    sput v0, Lkotlinx/coroutines/v;->f:I
...
.method private final p()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/v;->u()I
...
.method private static final r(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Runnable;)Ljava/lang/Thread;
    .locals 2
...
.method private final s()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/v;->p()Ljava/util/concurrent/ExecutorService;
    ...
    :cond_1
    sget-boolean v2, Lkotlinx/coroutines/v;->g:Z

    const/4 v3, 0x0

    if-nez v2, :cond_6

    sget v2, Lkotlinx/coroutines/v;->f:I
    ...
    :cond_3
    sget-object v4, Lkotlinx/coroutines/v;->e:Lkotlinx/coroutines/v;

    invoke-virtual {v4, v1, v2}, Lkotlinx/coroutines/v;->v(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    ...
    invoke-direct {v4}, Lkotlinx/coroutines/v;->u()I
...
.method private final declared-synchronized t()Ljava/util/concurrent/Executor;
    .locals 1
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/v;->s()Ljava/util/concurrent/ExecutorService;
...
.method private final u()I
    ...
    sget v0, Lkotlinx/coroutines/v;->f:I
    ...
    invoke-static {v0, v2}, Ld/x/d;->a(II)I
...
.method public static synthetic x()V
    ...
    invoke-static {}, Lkotlinx/coroutines/v;->w()V
...
.method public static synthetic y(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Runnable;)Ljava/lang/Thread;
    ...
    invoke-static {p0, p1}, Lkotlinx/coroutines/v;->r(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Runnable;)Ljava/lang/Thread;
...
.method public k(Ld/s/g;Ljava/lang/Runnable;)V
    .locals 1
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/v;->t()Ljava/util/concurrent/Executor;
    ...
    :goto_1
    sget-object p1, Lkotlinx/coroutines/q0;->j:Lkotlinx/coroutines/q0;

    invoke-virtual {p1, p2}, Lkotlinx/coroutines/z0;->G(Ljava/lang/Runnable;)V
...
.method public final v(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    .locals 4
    ...
    sget-object v0, Lkotlinx/coroutines/a;->d:Lkotlinx/coroutines/a;
